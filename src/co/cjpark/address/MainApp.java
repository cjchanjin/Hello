...
import co.cjpark.address.model.Person;
import co.cjpark.address.model.PersonListWrapper;
import co.cjpark.address.view.BirthdayStatisticsController;
import co.cjpark.address.view.PersonEditDialogController;
import co.cjpark.address.view.PersonOverviewController;
import co.cjpark.address.view.RootLayoutController;
...
public class MainApp extends Application {
	...
	public void start(Stage primaryStage) {
		...
		this.primaryStage.setTitle("AddressApp");		//타이틀 -> 실행시 app 상단 제목이 된다
		
		// 애플리케이션 아이콘을 설정한다.
	    this.primaryStage.getIcons().add(new Image("file:resources/images/iconfinder_contacts_1055082.png"));
